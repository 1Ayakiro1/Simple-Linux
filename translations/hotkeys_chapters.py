hotkeys_translations = {
    ...
    "ru": {
        "introduction_topic": "В этом разделе вы познакомитесь с горячими клавишами в Linux...",
...
• <span color="#00B7EB"><b>Ctrl + Alt + стрелки влево/вправо</b></span>: Переключение между рабочими столами (в некоторых дистрибутивах).
...
• <span color="#00B7EB"><b>Super + G</b></span>: Включить/выключить игровую компоновку окон (для минимизации задержек).""",
    ...
    "zh": {
        "introduction_topic": "TODO: translate",
        "gnomehotk": "TODO: translate",
        "kdehotk": "TODO: translate",
        "terminalhotk": "TODO: translate",
    },
    "ja": {
        "introduction_topic": "TODO: translate",
        "gnomehotk": "TODO: translate",
