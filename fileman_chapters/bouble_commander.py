...
# Label
label = Gtk.Label(label=fileman_translations[current_language]["bouble_commander"])
label.set_use_markup(True)
dynamic_labels.append((label, "bouble_commander"))
label.add_css_class("double_commander")
label.set_wrap(True)
label.set_xalign(0)
...
def get_bouble_commander_text():
    return fileman_translations[current_language]["bouble_commander"]